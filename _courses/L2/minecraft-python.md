...
- title: " Building a foundation for high school AP CS courses"
  text: "The study of Python is a great introductory foundation for taking the two existing high school AP CS courses. Not only does it satisfy the immediate requirements of AP CS Principle, but it also helps students transition more smoothly into the Java programming language required by AP CS A."
